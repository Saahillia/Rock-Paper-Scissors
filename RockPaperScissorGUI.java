...
public class RockPaperScissorGUI extends JFrame implements ActionListener {
    ...
    // this will display the choice of computer
    JLabel computerChoice;

    // will display the score of the computer and player
    ...
    public RockPaperScissorGUI(){
        ...
        // set input to null to disable layout management, so we can use absolute partioning for the elements
        ...
        // load the GUI in the center of the screen everytime we run the application
    ...
    // displays a message dialog which will show the winner and try ahain button to play again
    ...
    public void actionPerformed(ActionEvent e){
        ...
        // play roock paper scissor and store the score into string variable
